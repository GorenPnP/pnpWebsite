...
- **Else** try this:
  ...
  - execute `pg_restore  -U admin -d goren_db -1 var/lib/postgresql/backups/*.psql.bin` in postgres-container after copying the backup file (will prompt for password)
