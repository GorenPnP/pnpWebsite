...
urlpatterns = [
	...
	path('regions/', spielleiter_only('crafting:inventory')(views.RegionListView.as_view()), name='regions'),
	path('mining/<int:pk>/', spielleiter_only('crafting:inventory')(views.MiningView.as_view()), name='mining'),
