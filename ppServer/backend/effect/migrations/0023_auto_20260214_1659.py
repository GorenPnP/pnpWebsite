...
def delete_deprecated(apps, schema_editor):
    '''
    - Look through all chars and deacivate all RelEffects to be deleted
    - delete all Releffects with deprecated fields
    - delete all effects with deprecated fields
    '''
    ...
    deprecated_things = [
        "character.Charakter.natürlicher_schadenswiderstand_rüstung",
        "character.Charakter.rüstung_haltbarkeit",
        "character.Charakter.natSchaWi_pro_erfolg_bonus",
        "character.Charakter.natSchaWi_pro_erfolg_rüstung",
        "character.Charakter.astralwiderstand_pro_erfolg_bonus",
    ]

    # trigger deactivation pre_delete
    for e in RelEffect.objects.filter(target_fieldname__in=deprecated_things):
        e.delete()
    
    Effect.objects.filter(target_fieldname__in=deprecated_things).delete()


class Migration(migrations.Migration):

    dependencies = [
        ('effect', '0022_alter_effect_target_fieldname_and_more'),
    ]
