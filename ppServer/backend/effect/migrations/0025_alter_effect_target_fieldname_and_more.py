...
def delete_deprecated(apps, schema_editor):
    ...
    for e in RelEffect.objects.filter(target_fieldname='character.Charakter.rang'):
        e.delete()
    
    Effect.objects.filter(target_fieldname='character.Charakter.rang').delete()


class Migration(migrations.Migration):

    dependencies = [
        ('effect', '0024_effect_wertaenderung_str_releffect_wertaenderung_str_and_more'),
    ]
