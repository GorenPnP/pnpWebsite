...
class CharacterForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            "items", "waffenWerkzeuge", "magazine", "fernkampfwaffen", "magischeAusrüstung", "rituale_runen", "rüstungen", "ausrüstungTechnik", "fahrzeuge", "einbauten", "zauber", "begleiter", "engelsroboter",
        ]
        ...
        return Layout(
            TabHolder(
                ...
                Tab(
                    ...
                    Fieldset(
                        "Boni",
                        "initiative_bonus", "physische_reaktion_bonus", "physischer_widerstand_bonus", "physischer_widerstand_bonus_str", "astrale_reaktion_bonus", "astraler_widerstand_bonus_str", "manaoverflow_bonus", "nat_regeneration_bonus", "immunsystem_bonus"
                    ),
                ),
                Tab(
                    "Attribute",
