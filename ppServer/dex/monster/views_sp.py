...
class MonsterVisibilityView(VerifiedAccountMixin, SpielleitungOnlyMixin, TemplateView):
...
class AttackToMonsterView(VerifiedAccountMixin, SpielleitungOnlyMixin, TemplateView):
