    ...
    def get_calculated(self, char):
        ...
        return {
            "calculated__fields": [
                ...
                ["nat. Schadenswiderstand", num(attrs["ST"] + attrs["VER"] + char.natürlicher_schadenswiderstand_bonus + char.natürlicher_schadenswiderstand_rüstung)],
                ["nat. Schadensverhinderung", f'{1+ num(math.floor(min(attrs["ST"], attrs["VER"]) / 6) + char.natSchaWi_pro_erfolg_bonus + char.natSchaWi_pro_erfolg_rüstung)}HP / Erfolg'],
